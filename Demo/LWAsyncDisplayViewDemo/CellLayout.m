...
/**
 *  celllayout 本身在cell计算布局好传出到tableviewcell
 */
    ...
    if (self) {
        ...
        @autoreleasepool {
            ...
            [LWTextParser parseTopicWithLWTextStorage:contentTextStorage
                                            linkColor:RGB(113, 129, 161, 1)
                                       highlightColor:RGB(0, 0, 0, 0.15)];
            [LWTextParser parseAccountWithTextStorage:contentTextStorage linkColor:RGB(113, 129, 161, 1) highlightColor:RGB(0, 0, 0, 0.15)];
            ...
            dateTextStorage.textColor = [UIColor redColor];
